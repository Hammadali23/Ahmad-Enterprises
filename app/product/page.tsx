  ...
  const products = [
    ...
    },
    {
    ...
    },
     {
      ...
      desc: "It designed for precise monitoring of system pressure.Ensures stable and accurate performance in HVAC and industrial applications Compact, durable design for reliable long-term operation under varying conditions.",
      images: ["/TR-12DA057.jpg","/TR-12DA057-2.jpg"],
    },
    {
      name: "Carrier Sensor Part# HH79NZ047 ",
      desc: "The Carrier HH79NZ047 is an OEM temperature sensor designed for Carrier HVAC systems.It operates on 5 V DC with a 2-pin male connector and supports a temperature range of approximately −40 °C to +120 °C.",
      images: ["/SR-79NZ047.jpg","/SR-79NZ047.jpg"],
    },
    {
      name: "Carrier Suction Pressure Transducer Part# 00PPG000012100A",
      desc: "The Carrier 00PPG000012100A is an OEM suction pressure transducer designed for Carrier HVAC and chiller systems. It accurately measures suction line pressure, ensuring reliable system performance and control.",
      images: ["/TR-12100","/TR-12100-2"],
    },
    {
              ...
              >
                <div className="relative w-FULL h-64 overflow-hidden bg-gray-100">
                  ...
                  <img
                    ...
                    alt={product.name}
                    className="w-full h-full transition-all duration-500 transform hover:scale-110"
                  />
                </div>
